...
root_dir = '../reid-data/'
target_dir = root_dir + 'occluded_duke/'
origin_duke_dir = os.path.join(root_dir,'DukeMTMC-reID') # the temp folder to save the extracted images
...
def read_origin_duke_zip():
    ...
    with ZipFile(zip_file) as z:
        z.extractall(path=origin_duke_dir)
