...
from torchreid.losses import KHardNegativeTriplet, CrossEntropyLoss

from ..engine import Engine


class ImageKHardTripletEngine(Engine):
    ...
    def __init__(
        ...
        super(ImageKHardTripletEngine, self).__init__(datamanager, use_gpu)
        ...
        self.criterion_t = KHardNegativeTriplet(margin=margin)
